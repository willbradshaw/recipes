...
<div class="preamble">
**Source:** *Curry Easy Vegetarian*, p. 18

**Rating:** ★★☆☆☆

**Servings:** 4

**Calories/serving:** 145

**Dietary requirements:** Vegan, gluten-free, no major allergens

**Other notes:** Not a fan of this one
</div>
...
5. Put the **oil** in a small frying pan and set over medium-high heat. When hot, add the **asafoetida** and let it sizzle for a few seconds, then add the **spice mix** and stir for a few seconds.
6. Add the **curry leaves** to the frying pan, stir once, then pour the contents of the frying pan into the soup.
7. Reheat the soup, removing the **chilli** and **curry leaves** before serving.
